...
model.compile(
    gen_G_optimizer=keras.optimizers.AdamW(learning_rate=scheduler, beta_1=0.7),
    gen_F_optimizer=keras.optimizers.AdamW(learning_rate=scheduler, beta_1=0.7),
    disc_X_optimizer=keras.optimizers.AdamW(learning_rate=scheduler, beta_1=0.7),
    disc_Y_optimizer=keras.optimizers.AdamW(learning_rate=scheduler, beta_1=0.7),
